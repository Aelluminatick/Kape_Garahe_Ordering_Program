...
function getTotal()
{
	...
	var qty52=document.getElementById("qty52").value;
		//ALTERATION OF FORMULA by Aellu
	 var tprice1=price1*item1/2;
	 var tprice2=price2*item2/2;
	 var tprice3=price3*item3/2;
	 var tprice4=price4*item4/2;
	 var tprice5=price5*item5/2;
	 var tprice6=price6*item6/2;
	 var tprice7=price7*item7/2;
...
function receipt() {
		...
		var qty = 0;
           ...
           document.write("<td><input type=text id=price name=price value='" + 'Mocha' +"' readonly</td>");
