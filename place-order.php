            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light"><b style="font-size:25px;">&#8369;<?php echo $balance;?></b>
...
<?php
	...
	{
		if(is_numeric($key)){		
		$result = mysqli_query($con, "SELECT * FROM coffeebasedfrappe WHERE id = $key");
		while($row = mysqli_fetch_array($result))
		{
			$price = $row['price'];
			$item_name = $row['name'];
